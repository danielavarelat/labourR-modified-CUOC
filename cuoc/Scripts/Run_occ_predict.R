...
output_folder <- "/Users/DVARELAT/Documents/NLP/labourR/R/cuoc/Results/"

source("/Users/DVARELAT/Documents/NLP/labourR/R/cuoc/Scripts/occupations_classify_new.R")
...
### INPUTS our labourR -------- 
{
  ...
  level1_tfidf <- readRDS(paste0(data_folder,"tfidf_tokens_level1_den.rds"))
  granular_tfidf <- readRDS(paste0(data_folder,"tfidf_tokens_cuoc.rds"))
  vocabulary_domain <- readRDS(paste0(data_folder,"domain_specific_v1.rds"))
}
...
tic("Procesando...")
{
  ...
  fwrite(predictions_dt, "cuoc_predictions.csv")
}
toc()
...
df_couc <-  read.csv('/Users/DVARELAT/Documents/NLP/labourR/R/cuoc/Data/nombre_desc_occ2022.csv')
colnames(df_couc)
